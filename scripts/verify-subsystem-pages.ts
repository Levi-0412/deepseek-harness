...
export const GROUPS_WITHOUT_SUBSYSTEM_PAGE: Readonly<Record<string, string>> = {
  ...
  rdagent: 'Integration adapters for an external research framework whose own on-disk formats stay authoritative; the bridge package README owns the served routes.',
