...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-rdagent': { kind: 'none', reason: 'Browser-side trace-browser surface; renders RD-Agent logs without changing model context.' },
  ...
  'packages/rdagent/rdagent-bridge': { kind: 'none', reason: 'Host-side read-only trace bridge; serves RD-Agent logs over HTTP and registers nothing model-facing.' },
